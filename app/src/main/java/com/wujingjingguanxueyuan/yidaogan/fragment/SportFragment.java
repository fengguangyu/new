...
//                    Log.e("里程", ":" + distance_values+"km");
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        BmobQuery<SportEntry> sportEntry = new BmobQuery<>();
        sportEntry.addWhereEqualTo("user",BmobUser.getCurrentUser());
        sportEntry.findObjectsObservable(SportEntry.class).subscribe(new Subscriber<List<SportEntry>>() {
            ...
            @Override
            public void onNext(List<SportEntry> sportEntries) {
    ...
    private void initValues(){
        ...
        custom_steps = currentUser.step_plan;//用户的步数
        custom_step_length = Integer.valueOf(currentUser.getLength());//用户的步长
        custom_weight = Integer.valueOf(currentUser.getWeight());//用户的体重
...
//        Log.e("体重", custom_weight + "公斤");
        ...
        if(sportentry!=null &&sportentry.sport_steps!= null){
            history_values = sportentry.sport_steps.intValue();
        }
