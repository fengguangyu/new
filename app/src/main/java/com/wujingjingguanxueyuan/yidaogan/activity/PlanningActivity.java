...
public class PlanningActivity extends BaseActivity implements View.OnFocusChangeListener,View.OnClickListener{
    ...
    protected void setActivityTitle() {
        ...
        setTitleTextColor(getResources().getColor(R.color.black));//设置字体颜
    ...
    private void saveCustomSettingValues(String start_dates, String stop_dates){
       ...
       currentUser.plan_start_date = start_dates;
       currentUser.plan_start_year = start_year;
       currentUser.plan_start_month = start_month;
       currentUser.plan_start_day = start_date;
       currentUser.plan_stop_date = stop_dates;
       currentUser.plan_stop_month = stop_month;
       currentUser.plan_stop_day = stop_date;
       currentUser.plan_min_normal_weight_values = (float)((double)min_normal_weight);
       currentUser.plan_max_normal_weight_values = (float)((double)max_normal_weight);
       currentUser.plan_want_weight_values = plan_want_weight;
       currentUser.update();
    }
    /**
     * 屏蔽返回键
