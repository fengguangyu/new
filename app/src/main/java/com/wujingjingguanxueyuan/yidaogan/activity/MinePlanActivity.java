...
public class MinePlanActivity extends BaseActivity {
    ...
    private List<Plan> plan_List = new ArrayList<>();//储存计划数据
    ...
    private void getPlans(){
        ...
        planBmobQuery.addWhereEqualTo("user", BmobUser.getCurrentUser());
    ...
    class MyAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, final ViewGroup parent) {
         ...
         //   holder.date.setText(plan.start_year+plan.start_month+plan.start_day);//时间段
            ...
            holder.image.setImageBitmap(DemoApplication.bitmaps[plan.sport_type]);//类型

            final String id = plan.getObjectId();
            holder.change.setTag(id);
            holder.delete.setTag(id);
            holder.change.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (id == holder.change.getTag()){
                               ...
                               // datasDao.deleteValue("plans", "_id=?", new String[]{String.valueOf(id)});
                                ...
                                plan.delete(new UpdateListener() {
                                    ...
                                    public void done(BmobException e) {
                                        Toast.makeText(getApplicationContext(), "删除计划成功", Toast.LENGTH_SHORT).show();
                                    }
                                });
                            }
                        });
